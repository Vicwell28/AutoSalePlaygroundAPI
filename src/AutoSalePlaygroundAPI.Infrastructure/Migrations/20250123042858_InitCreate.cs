    ...
    public partial class InitCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleAccessory", x => new { x.AccessoryId, x.VehicleId });
                    table.ForeignKey(
                        name: "FK_VehicleAccessory_Accessories_AccessoryId",
                        column: x => x.AccessoryId,
                        principalTable: "Accessories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleAccessory_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAccessory_VehicleId",
