...
namespace AutoSalePlaygroundAPI.Application.Interfaces
{
    ...
    public interface IBaseService<T> where T : class, IEntity
    {
        ...
        /// </summary>
        /// <param name="specification">La especificación que define el filtro.</param>
        /// <returns>Lista de entidades que cumplen la especificación.</returns>
        Task<List<T>> ListAsync(ISpecification<T> specification);

        /// <summary>
        /// Obtiene la primera entidad que cumpla con una especificación.
        /// </summary>
        /// <param name="specification">La especificación a evaluar.</param>
        /// <returns>La primera entidad que cumple la especificación o <c>null</c> si no se encuentra.</returns>
        ...
        /// <param name="specification">La especificación que define el filtro.</param>
        /// <param name="selector">Expresión que define la proyección.</param>
        ...
        /// <param name="specification">La especificación a evaluar.</param>
        /// <param name="selector">Expresión que define la proyección.</param>
        /// <returns>El primer resultado proyectado o <c>null</c> si no se encuentra.</returns>
        ...
        /// </summary>
        /// <param name="specification">La especificación que define el filtro y la paginación.</param>
